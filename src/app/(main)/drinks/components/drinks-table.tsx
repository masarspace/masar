          ...
          <Table>
            <TableHeader>
              <TableRow>
                ...
                <TableHead className="hidden md:table-cell">Recipe</TableHead>
          ...
          <form onSubmit={handleFormSubmit}>
            ...
            <div className="grid gap-4 py-4">
              <div className="grid sm:grid-cols-4 items-center gap-2 sm:gap-4">
                ...
                <Input id="name" name="name" defaultValue={selectedDrink?.name} className="sm:col-span-3" required/>
              </div>
              <div className="grid sm:grid-cols-4 items-center gap-2 sm:gap-4">
                <Label htmlFor="price" className="sm:text-right">Price</Label>
                <Input id="price" name="price" type="number" step="0.01" defaultValue={selectedDrink?.price} className="sm:col-span-3" required/>
              </div>
              <div>
